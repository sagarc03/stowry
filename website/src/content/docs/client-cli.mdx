...
```bash
# amd64
curl -LO https://github.com/sagarc03/stowry/releases/latest/download/stowry-cli-linux-amd64
chmod +x stowry-cli-linux-amd64
sudo mv stowry-cli-linux-amd64 /usr/local/bin/stowry-cli

# arm64
curl -LO https://github.com/sagarc03/stowry/releases/latest/download/stowry-cli-linux-arm64
chmod +x stowry-cli-linux-arm64
sudo mv stowry-cli-linux-arm64 /usr/local/bin/stowry-cli
```
...
curl -LO https://github.com/sagarc03/stowry/releases/latest/download/stowry-cli-darwin-arm64
chmod +x stowry-cli-darwin-arm64
sudo mv stowry-cli-darwin-arm64 /usr/local/bin/stowry-cli

# Intel
curl -LO https://github.com/sagarc03/stowry/releases/latest/download/stowry-cli-darwin-amd64
chmod +x stowry-cli-darwin-amd64
sudo mv stowry-cli-darwin-amd64 /usr/local/bin/stowry-cli
```

#### Windows

Download `stowry-cli-windows-amd64.exe` from the releases page and add it to your PATH.
