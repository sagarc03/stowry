...
For production, disable public access and use presigned URLs. See the [Authentication guide](authentication) for generating presigned URLs with the `sign` package or an AWS SDK.
